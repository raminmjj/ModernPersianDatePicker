...
public partial class MvvmToolkitWindow : Window
{
    private readonly MvvmToolkitWindowViewModel _vm;

    public MvvmToolkitWindow()
    {
        InitializeComponent();
        _vm = (MvvmToolkitWindowViewModel)DataContext!;
